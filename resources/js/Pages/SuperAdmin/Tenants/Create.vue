                        ...
                        <div class="form-section">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    >
                                    <small class="text-muted">Username for admin login (lowercase, numbers, dash, underscore)</small>
                                ...
                                <div class="col-md-6">
                                    ...
                                    >
                                        ...
                                        <option v-for="plan in plans" :key="plan.id" :value="plan.slug">
                                            {{ plan.name }} - Rp {{ plan.price_monthly.toLocaleString() }}/month
                                        </option>
                                    </select>
...
const form = useForm({
    ...
    timezone: 'Asia/Jakarta', // ✅ Add timezone with default
    subscription_plan: '',
    status: 'trial',
    trial_days: 14,
    admin_name: '',
