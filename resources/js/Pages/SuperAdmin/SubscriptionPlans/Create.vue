        ...
        <div class="container-fluid">
            <div class="page-header">
                <div>
                    ...
                    <h3 class="page-title">Create New Subscription Plan</h3>
                    <p class="page-subtitle">Add a new subscription plan for tenant registration</p>
                </div>
            </div>
...
const submit = () => {
    form.post(route('superadmin.subscription-plans.store'), {
        onSuccess: () => {
...
<style scoped>
/* Same styles as Tenants/Create.vue */
.page-header {
    margin-bottom: 32px;
}
